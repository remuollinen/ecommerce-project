            ...
            <div className="single-product-page">
                    <div id="prduct-left">
                        ...
                        <div className="product-description">
                            <h2>Description</h2>
                                <p> {this.state.singleProduct.description} Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
                        ...
                        <div className="image-wrapper">
                            <img src={this.state.singleProduct.image} alt={this.state.singleProduct.title}/>
                        </div>
